 ...
 */
	...
	$smtp->host_name="smtp.126.com"; //IP address       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->user="hw_henry2008@126.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="Yx&Jjen3@H";                 /* Set to the authetication password */
